          ...
          {isForgotPassword ? (
            <>
              <div className="mb-6">
                ...
                <p className="text-slate-500 text-sm mt-1">Masukkan email kamu, kami kirim link reset.</p>
              </div>
              <form onSubmit={handleForgotPassword} className="space-y-4">
                ...
                {message && (
                  <div className="bg-green-50 border border-green-200 rounded-2xl px-4 py-3 text-green-600 text-sm">{message}</div>
                )}

                <button
                  type="submit"
                  disabled={loading}
                  className="w-full bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-bold py-3 rounded-2xl transition-all disabled:opacity-50 shadow-lg shadow-blue-200"
                >
              ...
              <button
                ...
                className="w-full text-center text-sm text-slate-500 hover:text-slate-700 mt-4 font-medium"
              >
                ← Kembali ke Login
              </button>
            </>
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      required
                      minLength={6}
                      className="w-full bg-slate-50 border border-slate-200 text-slate-900 placeholder-slate-400 rounded-2xl px-4 py-3 pr-12 text-sm focus:outline-none focus:border-blue-400 focus:ring-2 focus:ring-blue-100 transition-all"
                    />
                    <button
                      type="button"
